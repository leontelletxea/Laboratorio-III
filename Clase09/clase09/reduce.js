...
console.log(total);
//c.- CON REDUCE Y =>
total = nums.reduce(function (anterior, actual) { return anterior + actual; }, 0);
console.log(total);
...
var productosTotal = [];
var totalStock = 0;
for (var i = 0; i < productosInventario.length; i++) {
...
console.log(totalStock);
//c.- CON REDUCE Y =>
totalStock = productosInventario.reduce(function (anterior, actual, index, array) { return anterior + actual.stock; }, 0);
console.log(totalStock);
