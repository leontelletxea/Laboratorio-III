...
var TestPrueba;
(function (TestPrueba) {
    var alumno1 = new Prueba.Alumno("Mazzucchelli", "Juan", 109755);
    var alumno2 = new Prueba.Alumno("Mazzucchelli", "Juan", 109755);
    var alumno3 = new Prueba.Alumno("Mazzucchelli", "Juan", 109755);
    var lista = Array();
